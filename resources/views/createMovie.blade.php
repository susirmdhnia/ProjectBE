...
<div class="p-5">
          ...
          <form action="{{route('store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input value="{{old('runningTime')}}" type="text" class="form-control" id="" name="runningTime">
            </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{old('producer')}}" type="text" class="form-control" id="" name="producer">
            </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{old('actor')}}" type="text" class="form-control" id="" name="actor">
            </div>
            @error('actor')
              <div class="alert alert-danger" role="alert">{{$message}}</div>
            @enderror
